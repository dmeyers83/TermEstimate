...
roles = ["Brand Manager","Brand Specialist","Marketing Manager", "Digital Media Manager","Brand Strategy Manager"]
...
print("print final")
df_final.to_csv('Marketing_Keywords_granular.csv')
df_final.head()
...
df_final_count.to_csv('Marketing_Keywords_summary.csv')
